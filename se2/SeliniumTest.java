...
public class SeliniumTest {
    ...
    public static void main(String[] args) {
        ...
        System.setProperty("webdriver.chrome.driver",
                "C:\\Users\\jvang\\OneDrive\\Attachments\\selenium testing\\chromedriver-win64\\chromedriver.exe");
        WebDriver driver = new ChromeDriver();

        try {
            // Open the web application (local file or server URL)
            driver.get("C:\\Users\\jvang\\OneDrive\\Attachments\\selenium testing\\SeliniumTest.html");

            // Wait for the element with id 'a' to be visible
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10)); // Wait for 10 seconds using
                                                                                    // Duration
